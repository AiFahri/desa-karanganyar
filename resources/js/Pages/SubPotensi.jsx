...
const dataPotensi = [
  {
    ...
    deskripsi_lengkap: "Cimol Baper adalah produk UMKM unggulan yang menawarkan cita rasa autentik dengan kualitas terbaik. Dibuat dengan bahan-bahan pilihan dan resep turun temurun yang telah terbukti kelezatannya. Setiap gigitan memberikan pengalaman kuliner yang tak terlupakan.",
    menu_umkm: "Cimol",
  },
];
...
const MenuItem = ({ title, price, description }) => (
  <div className="flex items-start">
    ...
    <div>
      <p className="font-semibold text-gray-800">{title}{price && ` - ${price}`}</p>
      {description && (
...
const ContactSection = ({ phoneNumber, className = "" }) => (
  <div className={`mb-6 ${className}`}>
    <h3 className="text-lg font-bold text-gray-800 mb-3">Kontak Pemesanan</h3>
...
const SocialMediaSection = ({ tiktok, facebook, instagram, className = "" }) => (

      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          <div className="bg-white rounded-lg shadow border border-[#D9D9D9] px-12 py-10 max-w-[1400px] mx-auto">
            <h1 className="text-[40px] font-bold text-center mb-6">Tambah UMKM</h1>
            ...
            <form className="flex flex-wrap gap-10">
              ...
              <div className="flex flex-col gap-6 w-[500px]">
                <div>
                  <label className="text-[18px] font-semibold mb-2 block">Merk Dagang UMKM</label>
                  <input
                    type="text"
                    placeholder=""
                ...
                <div>
                  ...
                  <textarea
                    rows="3"
                    className="w-full px-5 py-3 border border-[#D9D9D9] bg-[#FDFCFC] rounded-lg text-sm font-semibold text-black placeholder:text-black/45"
                  />
                </div>
...
export default AdminTambahUMKM;

...
const NavLink = ({ href, children }) => {
    const { url } = usePage();
    const isActive = url === href || (href === '/' && url === '/');
            ...
            <div className="mx-0 px-4 sm:px-6 lg:px-16 w-full">
                <div className="flex items-center justify-between h-[76px]">
                    ...
                    <button
                        ...
                        className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                    >

            ...
            <div className="max-w-7xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-200">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="mt-4 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
                        Grafik berikut menunjukkan data jumlah kepala keluarga,
                        penduduk laki-laki, perempuan, dan total penduduk di
                        Desa {stats.villageName || "Karanganyar"}, Kecamatan{" "}
                        ...
                        <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                            <div className="bg-blue-600 p-5 text-white">
                                ...
                                <h2 className="text-2xl font-bold mt-2">
                                    Desa {stats.villageName || "Karanganyar"}
                                </h2>
                                <p className="text-sm opacity-90">
                                    Kecamatan {stats.district || "Poncokusumo"},

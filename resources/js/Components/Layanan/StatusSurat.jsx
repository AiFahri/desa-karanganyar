                    ...
                    >
                        ...
                        {pengajuan ? (
                            <div className="space-y-6">
                                <div>
                                    <label className="block mb-2 font-semibold md:text-[18px] text-[14px]">
                                ...
                                <div>
                                    <label className="block mb-2 md:text-[18px] text-[14px] font-semibold">
                        ...
                        <div className="flex justify-center mt-10">
                            <button
                                className={`md:text-[18px] text-[14px] flex items-center gap-2 px-6 py-3 border rounded-lg font-semibold transition ${
                                    pengajuan
                                        ? getStatusColor(pengajuan.status)
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M6.125 8.75L9.7425 12.3675C9.77766 12.4026 9.82531 12.4223 9.875 12.4223C9.92469 12.4223 9.97234 12.4026 10.0075 12.3675L19.875 2.5"
                                        stroke="#1BAF52"
                                        strokeWidth="1.25"
                                    />
                                </svg>

...
const BuatSurat = ({ suratJenis }) => {
    ...
    return (
        <div className="pt-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mt-16 mb-20 max-w-6xl mx-auto">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="lg:col-span-2 flex justify-center lg:justify-end mt-8">
                        <motion.button
                            ...
                            className="flex items-center justify-center gap-4 px-6 py-3 bg-gradient-to-b from-[#0272BA] to-[#95CFF4] hover:from-[#0272BA] hover:to-[#0272BA] text-white font-semibold rounded-md transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed min-w-[150px]"
                        >
                            {processing ? (
                                <>
                                    <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
                                    <span>
                                        Mengirim... {progress?.percentage || 0}%
                                    </span>
                                </>
                            ) : (
                                <>

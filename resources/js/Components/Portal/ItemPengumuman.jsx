  ...
  return (
    ...
    <div className="border border-gray-200 w-full rounded-lg p-6 flex flex-col lg:flex-row lg:justify-between lg:items-end bg-white my-4 gap-6 lg:gap-4 lg:p-7 lg:px-14">
      ...
      <div>
        ...
        <div className="text-[#0272BA] font-medium text-sm mb-2">{date}</div>
        <p className="text-black opacity-50 max-w-3xl">{description}</p>
      </div>
      ...
      <motion.div
        ...
        className="text-white cursor-pointer font-sans font-semibold rounded-lg px-4 py-3 flex items-center justify-between shadow transition w-full lg:w-auto lg:min-w-[260px] lg:text-lg text-sm"
      >
        {buttonText}

...
const ItemPortal = ({
  ...
  return (
    <div className="border border-gray-200 w-full rounded-lg p-7 px-14 flex justify-between items-end bg-white max-w-full my-4">
      ...
      <motion.div
        ...
        className="text-white cursor-pointer font-sans font-semibold rounded-lg px-4 py-3 flex items-center shadow transition"
      >
        {buttonText}
